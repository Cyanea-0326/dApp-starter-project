...
const App = () => {
  ...
  const contractAddress = "0x84EC5C1B8182AD25cF98A113360c583bC7BC7381";
  ...
  return (
    <div className="mainContainer">
      <div className="dataContainer">
        ...
        <div className="bio">
          Connect ur ETH wallet and wave at me!!
          <span role="img" aria-label="hand-wave">
            👋
          </span>
        ...
        {currentAccount && (
            <p>
              Your Wallet: {currentAccount}
            </p>
        )}
        {currentAccount && (
            <p>Total waves: {totalWaves}</p>
        )}      
        {currentAccount && (
